...
import kotlinx.android.synthetic.main.fragment_seccion_antescedentes_personales3.*

class SeccionAntescedentesPersonales3Fragment : Fragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_seccion_antescedentes_personales3, container, false)
    }
