...
import kotlinx.android.synthetic.main.fragment_seccion_cancer3.*

class SeccionCancer3Fragment : Fragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_seccion_cancer3, container, false)
    }
