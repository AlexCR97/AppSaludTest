            ...
            override fun alCambiarActividad(numeroFragmento: Int) {
                ...
                when {
                    ...
                    EncuestaSingleton.integrantesEsquemas.count { integranteEsquema -> integranteEsquema.tipoCartilla == TipoCartilla.ADULTO_HOMBRE } != 0 -> {
                        Log.e("salud", "hombres")
                        val intent = Intent(this@SeccionEsquemaVacunacionAdolescenteActivity, SeccionEsquemaVacunacionAdultoHombreActivity::class.java)
                    ...
                    EncuestaSingleton.integrantesEsquemas.count { integranteEsquema -> integranteEsquema.tipoCartilla == TipoCartilla.ADULTO_MUJER } != 0 -> {
                        Log.e("salud", "mujeres")
                        val intent = Intent(this@SeccionEsquemaVacunacionAdolescenteActivity, SeccionEsquemaVacunacionAdultoMujerActivity::class.java)
                        startActivity(intent)
                    }
                    ...
                    EncuestaSingleton.integrantesEsquemas.count { integranteEsquema -> integranteEsquema.tipoCartilla == TipoCartilla.ADULTO_MAYOR } != 0 -> {
                        ...
                        val intent = Intent(this@SeccionEsquemaVacunacionAdolescenteActivity, SeccionEsquemaVacunacionAncianoActivity::class.java)
                        startActivity(intent)
                    }
                    ...
                    // si nadie tiene esquema de vacunacion
                        ...
                        val intent = Intent(this@SeccionEsquemaVacunacionAdolescenteActivity, SeccionOtrosActivity::class.java)
                        startActivity(intent)
                    }
                }
