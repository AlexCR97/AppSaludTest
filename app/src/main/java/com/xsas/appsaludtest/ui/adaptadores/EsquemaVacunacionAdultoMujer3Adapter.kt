...
class EsquemaVacunacionAdultoMujer3Adapter(val vistas: ArrayList<EsquemaVacunacionAdultoMujer3>, val context: Context) : RecyclerView.Adapter<EsquemaVacunacionAdultoMujer3Adapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val lista = itemView.findViewById<LinearLayout>(R.id.llEsquemaVacunacionAdultoMujer3)

        val bFechaVacunacionAdultoMujerTdpaUnica = itemView.findViewById<Button>(R.id.bFechaVacunacionAdultoMujerTdpaUnica)
