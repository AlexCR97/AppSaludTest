...
import kotlinx.android.synthetic.main.fragment_seccion_antescedentes_personales1.*

class SeccionAntescedentesPersonales1Fragment : Fragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_seccion_antescedentes_personales1, container, false)
    }
