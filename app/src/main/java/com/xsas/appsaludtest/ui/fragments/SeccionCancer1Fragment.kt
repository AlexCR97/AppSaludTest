...
import kotlinx.android.synthetic.main.fragment_seccion_cancer1.*

class SeccionCancer1Fragment : Fragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_seccion_cancer1, container, false)
    }
