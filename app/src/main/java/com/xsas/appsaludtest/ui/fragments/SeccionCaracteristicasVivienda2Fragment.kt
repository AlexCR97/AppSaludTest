...
import kotlinx.android.synthetic.main.fragment_seccion_caracteristicas_vivienda2.*

class SeccionCaracteristicasVivienda2Fragment : Fragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_seccion_caracteristicas_vivienda2, container, false)
    }
