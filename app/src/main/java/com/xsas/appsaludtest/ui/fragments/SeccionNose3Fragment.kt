...
import kotlinx.android.synthetic.main.fragment_seccion_nose3.*

class SeccionNose3Fragment : Fragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_seccion_nose3, container, false)
    }
